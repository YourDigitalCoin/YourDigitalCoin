...
uint256 hashGenesisBlock("0x2823782d0567c584f45c907bba977b850394c09e6185f60d2586ae7301a4328d");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // YourDigitalCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "YourDigitalCoin Signed Message:\n";
...
{
    // YourDigitalCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // YourDigitalCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // YourDigitalCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // YourDigitalCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2823782d0567c584f45c907bba977b850394c09e6185f60d2586ae7301a4328d");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1397845534;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086268876;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("YourDigitalCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("YourDigitalCoinMiner : ProcessBlock, block not accepted");
    }
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running YourDigitalCoin with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("YourDigitalCoinMiner terminated\n");
        throw;
    }
}
